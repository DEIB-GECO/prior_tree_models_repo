...
for i in range(1,101):
    ...
    for v in r:
        ...
        classifier = tree.DecisionTreeClassifier(random_state=3*i, criterion="gini", w_prior=np.array(penalties), pk_configuration="on_feature_sampling", v=1, k=1, max_features='sqrt') 
